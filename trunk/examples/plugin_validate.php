...
if($ajax->isPlugin('validate')) {
	...
	<br />
	This pluing is by default not included in the this package. You must  download the zip and place it its content in cjax/plugins directory.
...
<ul>
 ...
 <li><a target="_blank" href="http://code.google.com/p/ajax-framework-for-codeigniter/downloads/list">http://code.google.com/p/ajax-framework-for-codeigniter/downloads/list</a></li>
</ul>
Code Used:
<?php 
